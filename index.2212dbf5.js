 ...
 * limitations under the License.
 */
class Cn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const Dn="@firebase/app",Un="0.7.10",Fn=new Nn("@firebase/app"),Vn="[DEFAULT]",jn={[Dn]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},Bn=new Map,Wn=new Map;function qn(e,t){try{e.container.addComponent(t)}catch(n){Fn.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function $n(e){const t=e.name;if(Wn.has(t))return Fn.debug(`There were multiple attempts to register component ${t}.`),!1;Wn.set(t,e);for(const t of Bn.values())qn(t,e);return!0}function Hn(e,t){return e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
var Xn;Xn="",$n(new In("platform-logger",(e=>new Cn(e)),"PRIVATE")),Jn(Dn,Un,Xn),Jn(Dn,Un,"esm2017"),Jn("fire-js","");
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Ur(e,t=!1){const n=e;await async function(e){const{registrationPromise:t}=await Mr(e);t&&await t}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n.appConfig);return(await Nr(n,t)).token}function Fr(e){return sr.create("missing-app-config-values",{valueName:e})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _o=new ys(3e4,6e4);function ko(){const e=Ua().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Io=null;function So(e){return Io=Io||function(e){return new Promise(((t,n)=>{var r,i,s;function a(){ko(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{ko(),n(as(e,"network-request-failed"))},timeout:_o.get()})}if(null===(i=null===(r=Ua().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Ua().gapi)||void 0===s?void 0:s.load)){const t=Ja("iframefcb");return Ua()[t]=()=>{gapi.load?a():n(as(e,"network-request-failed"))},Ya(`https://apis.google.com/js/api.js?onload=${t}`)}a()}})).catch((e=>{throw Io=null,e}))}(e),Io}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fu(e){return null==e}function Vu(e){return 0===e&&1/e==-1/0}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Nc{constructor(e,t=null,n=[],r=[],i=null,s="F",a=null,o=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=n,this.filters=r,this.limit=i,this.limitType=s,this.startAt=a,this.endAt=o,this.$=null,this.F=null,this.startAt,this.endAt}}function Cc(e){return!Fu(e.limit)&&"L"===e.limitType}function Dc(e){return e.explicitOrderBy.length>0?e.explicitOrderBy[0].field:null}function Uc(e){for(const t of e.filters)if(t.N())return t.field;return null}function Fc(e){return null!==e.collectionGroup}function Vc(e){const t=nu(e);if(null===t.$){t.$=[];const e=Uc(t),n=Dc(t);if(null!==e&&null===n)e.isKeyField()||t.$.push(new Lc(e)),t.$.push(new Lc(Ru.keyField(),"asc"));else{let e=!1;for(const n of t.explicitOrderBy)t.$.push(n),n.field.isKeyField()&&(e=!0);if(!e){const e=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";t.$.push(new Lc(Ru.keyField(),e))}}}return t.$}function jc(e){const t=nu(e);if(!t.F)if("F"===t.limitType)t.F=kc(t.path,t.collectionGroup,Vc(t),t.filters,t.limit,t.startAt,t.endAt);else{const e=[];for(const n of Vc(t)){const t="desc"===n.dir?"asc":"desc";e.push(new Lc(n.field,t))}const n=t.endAt?new Pc(t.endAt.position,!t.endAt.before):null,r=t.startAt?new Pc(t.startAt.position,!t.startAt.before):null;t.F=kc(t.path,t.collectionGroup,e,t.filters,t.limit,n,r)}return t.F}
/**
 * @license
 * Copyright 2020 Google LLC
 *
